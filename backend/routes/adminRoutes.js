...
// @desc   Register admin
// @access Public
// POST route to register a new hostel
router.post('/register-hostel', [
    check('name', 'Name is required').not().isEmpty(),
    check('location', 'Location is required').not().isEmpty(),
    check('rooms', 'Number of rooms is required and must be a number').isInt(),
    check('capacity', 'Capacity is required and must be a number').isInt(),
    check('vacant', 'Vacant rooms count is required and must be a number').isInt()
], registerHostel)
