...
function Leave() {
  ...
  const lables =["No req sent", "req sent", "req accept"];
  const loader = (
    <svg
    aria-hidden="true"
  ...
  return (
    <div className="w-full h-screen gap-10 flex flex-col items-center justify-center max-h-screen overflow-y-auto pt-[500px] sm:pt-96 md:pt-96 lg:pt-40">
      ...
      <form method="POST" onSubmit={requestLeave} className="bg-neutral-950 py-5 px-10 rounded-lg shadow-xl w-full sm:w-auto">
        <div className="flex gap-5">
          <Input field={leaveDateField} />
          <Input field={returnDateField} />
        </div>
        <button type="submit" className="w-full text-white bg-blue-600 hover:bg-blue-700 text-xl rounded-lg px-5 py-2.5 mt-5 text-center">
